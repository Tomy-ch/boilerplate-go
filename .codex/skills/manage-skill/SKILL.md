...
- **Normalize a rotted `description` whenever you touch a skill** — it is the one part of a skill
  ...
  filing them.
- Both of the above apply as a **sweep** too: run them across every `.codex/skills/*/SKILL.md` when
